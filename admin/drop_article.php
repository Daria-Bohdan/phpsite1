...
echo "<p>Ваша статья не удалена !</p>";
}

} else {
	echo "<p>Вы запустили данный файл без параметра id и поэтому, удалить статью невозможно.Скорее всего Вы не выбрали радиокнопку на предыдущем шаге. </p>";
}
