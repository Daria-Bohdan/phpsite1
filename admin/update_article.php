...
<head>
	<meta charset="UTF-8">
	<title>Обработчик редактирования статей UPDATE </title>
...
echo "<p>Ваша статья не обновлена !</p>";
}

} else {
	echo "<p>Вы ввели не всю информацию, поэтому статья в базе не может быть обновлена. </p>";
}
